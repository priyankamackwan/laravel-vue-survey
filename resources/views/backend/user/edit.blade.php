...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" id="user"  action="{{ route("admin.user.update", $user->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('phone_no') ? 'is-invalid' : '' }}" type="text" name="phone_no" id="phone_no" value="{{ old('phone_no', $user->phone_no) }}">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('experience') ? 'is-invalid' : '' }}" type="text" name="experience" id="experience" value="{{ old('experience', $user->experience) }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('skills') ? 'is-invalid' : '' }}" type="text" name="skills" id="skills" value="{{ old('skills', $user->skills) }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('education') ? 'is-invalid' : '' }}" type="text" name="education" id="education" value="{{ old('education', $user->education) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('designation') ? 'is-invalid' : '' }}" type="text" name="designation" id="designation" value="{{ old('designation', $user->designation) }}">{{ old('designation', $user->designation) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" type="text" name="notes" id="notes" value="{{ old('notes', $user->notes) }}">{{ old('notes', $user->notes) }}</textarea>
                @if($errors->has('notes'))
                    <div class="invalid-feedback">
                        {{ $errors->first('notes') }}
                    </div>
            ...
            <div class="col-md-12">
                <div class="col-md-6">
                    ...
                    <img id="blah1" src="{{ asset('/images/').'/'.$user->profile_image }}" alt="your image"  style="height: auto;width: 20%;"/><br>
                    @else
                    <img id="blah2" src="{{ asset('/images/default_profile.png')}}" alt="your image"  style="height: auto;width: 20%;"/>
                    @endif
